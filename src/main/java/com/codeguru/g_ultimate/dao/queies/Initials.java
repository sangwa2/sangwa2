...
public class Initials {
    ...
    String curr_child = "", curr_parent = "", prev_child, prev_parent = "", c = "", p = "";
    ...
    List<Mdl_rel_query> unit, loop_items_given_index;
    ...
    public List<Mdl_rel_query> getUnit() {
        return unit;
    }

    public void setUnit(List<Mdl_rel_query> unit) {
        this.unit = unit;
    }
    ...
    public void curr_p(String curr_parent, String curr_child, String c, String p) {
        if (!reps.contains(curr_parent)) {
            all_q += "\n..join " + curr_parent + " on " + join(curr_child, curr_parent);
...
//            }
    ...
    public void curr_c(String curr_child, String curr_parent, String c, String p) {
        if (!reps.contains(curr_child)) {
            all_q += "\n..join " + curr_child + " on " + join(curr_child, curr_parent);
...
//            }
    ...
    private String join(String curr_child, String curr_parent) {
